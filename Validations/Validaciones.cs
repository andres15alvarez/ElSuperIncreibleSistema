...
namespace ElSuperIncreibleSistema
{
    public class Validaciones : Form
    {
        ...
        public void Informacion(string message, string caption)
        {
        ...
        public void Confirmacion(string message, string caption)
        {
        ...
        public void Advertencia(string message, string caption)
        {
            MessageBoxButtons button = MessageBoxButtons.OK;
